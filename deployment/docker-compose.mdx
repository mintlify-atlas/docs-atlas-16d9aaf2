---
title: "WAF Auto-Block Docker Compose Server Deployment Guide"
sidebarTitle: "Docker Compose"
description: "Use Docker Compose to manage WAF Auto-Block on a server — supports versioned image tags, easy upgrades and rollbacks, and custom env file paths."
---
