...
description: "Configure WAF Auto-Block via appsettings.json or environment variables. Covers Cloudflare credentials, polling, storage, and detection settings."
---
